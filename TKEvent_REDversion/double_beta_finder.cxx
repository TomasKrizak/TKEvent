...
//-------------------------------------
	...
	if(event->get_no_tracks() != 2) continue;
	
	double x,y,z;
	double a0 = event->get_track_a(0);
	double b0 = event->get_track_b(0);
	double c0 = event->get_track_c(0);
	double d0 = event->get_track_d(0);
	
	double a1 = event->get_track_a(1);
	double b1 = event->get_track_b(1);
	double c1 = event->get_track_c(1);
	double d1 = event->get_track_d(1);
